...
def test_logger():
    ...
    :rtype: bool
    """
    from OSS_05_04_22.src import mylogger
    try:
        m = mylogger.get_logger('test', '/home/u1017/OSS_05_04_22/log')
        m.debug('hi, debug')
...
def test_config():
    ...
    :rtype: bool
    """
    from OSS_05_04_22.src import myconfig
    try:
        m = myconfig.get_config('/home/u1017/OSS_05_04_22/share/test.config')
